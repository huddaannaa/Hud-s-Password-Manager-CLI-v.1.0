...
from Enginehud import exc, util, const
from Enginehud.model import Group, Entry, RootGroup
from Enginehud.structs import HeaderStruct, GroupStruct, EntryStruct

__authors__ = ["Karsten-Kai König <kkoenig@posteo.de>", "Hans Lellelid <hans@xmpl.org>", "Brett Viren <brett.viren@gmail.com>"]
__license__ = """
Enginehud is free software: you can redistribute it and/or modify it under the terms
of the GNU General Public License as published by the Free Software Foundation,
either version 3 of the License, or at your option) any later version.

Enginehud is distributed in the hope that it will be useful, but WITHOUT ANY
WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR
A PARTICULAR PURPOSE. See the GNU General Public License for more details.

You should have received a copy of the GNU General Public License along with
Enginehud.  If not, see <http://www.gnu.org/licenses/>.
"""
...
class Database(object):
    ...
    :ivar groups: The flat list of groups (:class:`Enginehud.model.Group`) in this database.
    :ivar entries: The flat list of entries (:class:`Enginehud.model.Entry`) in this database.
    ...
    :ivar header: The database header struct (:class:`Enginehud.structs.HeaderStruct`).
    """
    root = None
    groups = None # The flat list of :class:`Enginehud.model.Group` groups in this database.
    entries = None
    ...
    def create_default_group(self):
        ...
        :rtype: :class:`Enginehud.model.Group`
        """
    ...
    def save(self, dbfile=None, password=None, keyfile=None):
        ...
        :type keyfile: str or file-like object
        :raise Enginehud.exc.ReadOnlyDatabase: If database was opened with readonly flag.
        """
        if self.readonly:
    ...
    def move_group(self, group, parent, index=None):
        ...
        :type group: :class:`Enginehud.model.Group`
        :param parent: The new parent for the group.
        :type parent: :class:`Enginehud.model.Group`
    ...
    def create_entry(self, group, **kwargs):
        ...
        :rtype: :class:`Enginehud.model.Entry`
        """
        if group not in self.groups:
            raise ValueError("Group doesn't exist / is not bound to this database.")
    ...
    def remove_entry(self, entry):
        ...
        :type entry: :class:`Enginehud.model.Entry`
        """
...
class LockingDatabase(Database):
    ...
    def acquire_lock(self, force=False):
        ...
        :type force: bool
        :raises: :class:`Enginehud.exc.DatabaseAlreadyLocked` - If the database is already locked (and force not set to True).
        """
        if self.readonly:
            raise exc.ReadOnlyDatabase()
        if not self._locked:
