...
of the database.  These classes are directly related to their :mod:`Enginehud.structs`
...
from Enginehud import const, util
from Enginehud.structs import GroupStruct, EntryStruct
...
class RootGroup(object):
    ...
    This is the `root` attribute of the :class:`Enginehud.db.Database` instance.
    ...
    :ivar children: List of children groups (:class:`Enginehud.model.Group`)
    """
    parent = None
    level = -1
    children = None
...
class Group(BaseModel):
    ...
    :ivar db: The parent database (:class:`Enginehud.db.Database`)
    ...
    :ivar parent: The parent group (:class:`Enginehud.model.Group`)
    :ivar children: List of children groups (:class:`Enginehud.model.Group`)
    :ivar entries: List of member entries (:class:`Enginehud.model.Entry`)
    """
...
class Entry(BaseModel):
    ...
    :ivar expires: When the entry (password) expires.  Default will be :ref:`Enginehud.const.NEVER`.
    ...
    def __init__(self, uuid = None, group_id = None, group = None,
        ...
        :keyword expires: When the entry (password) expires.  Default will be :ref:`Enginehud.const.NEVER`.
